 ...
 * @since 5.0
 */
public class WebSocketResourceResolver extends AbstractResourceResolver {
    ...
    logger.debug("resource.getClass(): " + resource.getClass() + " :: location.getClass(): " + location.getClass());
